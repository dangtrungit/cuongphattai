...
/***/ function(module, exports) {
	...
	fieldHTML.address = '<div class=\'address-cover field-cover\'><span class=\'sub-label-{{element.elementDefaults.has_sub_label}}\'><span compile=\'element.elementDefaults.main_label\' class=\'main-label\'></span><span class=\'sub-label\' compile=\'element.elementDefaults.sub_label\'></span></span><div><span class=\'error\'></span><input class=\'address-picker-field\' type=\'text\' name=\'{{element.elementDefaults.identifier}}\' placeholder="{{element.elementDefaults.main_label_placeholder}}" data-show-map=\'{{element.elementDefaults.map}}\' data-map-height=\'{{element.elementDefaults.map_height}}\' data-field-id=\'{{element.elementDefaults.identifier}}\'><div class=\'address-field-map\'></div></div></div>';
