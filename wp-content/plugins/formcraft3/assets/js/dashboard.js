...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	jQuery(document).ready(function () {
	  ...
	  */
	  var FilesCover = _react2.default.createClass({
	    displayName: 'FilesCover',
	    ...
	    render: function render() {
	      return _react2.default.createElement(
	        'form',
	        { className: 'fc_modal-content', id: 'new_form' },
	        _react2.default.createElement(
	          'div',
	          { className: 'fc_modal-header' },
	          _react2.default.createElement('i', { className: 'icon-upload-cloud' }),
	          _react2.default.createElement(
	            'h2',
	            null,
	            'File Uploads'
	          ...
	          _react2.default.createElement(
	            'button',
	            { className: 'close fc_close', 'data-dismiss': 'fc_modal', 'aria-label': 'Close' },
	            _react2.default.createElement(
	              'span',
	              { 'aria-hidden': 'true' },
	              '×'
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'fc_modal-body' },
	          _react2.default.createElement(
	            'span',
	            null,
	            _react2.default.createElement('i', { id: 'trash-files', onClick: this.onTrash, className: 'icon-trash-1' })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'file_list list' },
	            _react2.default.createElement(
	              'div',
	              { className: 'thead tr' },
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'label',
	                  null,
	                  _react2.default.createElement('input', { className: 'files_checked_parent groupCheckedParent', type: 'checkbox' })
	                )
	              ),
	              _react2.default.createElement(
	                'span',
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'tbody loading-' + this.props.loading },
	              this.state.files.map(function (file) {
	                return _react2.default.createElement(
	                  'div',
	                  { className: 'tr', key: file.id },
	                  _react2.default.createElement(
	                    'span',
	                    { style: { width: '8%' } },
	                    _react2.default.createElement(
	                      'label',
	                      null,
	                      _react2.default.createElement('input', { className: 'files_checked groupChecked', type: 'checkbox', value: file.id, name: 'del_files' })
	                    )
	                  ),
	                  _react2.default.createElement(
	                    'span',
	                    ...
	                    _react2.default.createElement(
	                      'a',
	                      { target: '_blank', href: '' + file.file_url },
	                      file.name
	                    )
	                  ),
	                  _react2.default.createElement(
	            ...
	            _react2.default.createElement(Pagination, { updatePage: this.updatePage, currentPage: this.state.currentPage, data: [this.state.pages] })
	          )
	        )
	      );
	    }
	  ...
	  */
	  var SubmissionCover = _react2.default.createClass({
	    displayName: 'SubmissionCover',
	    ...
	    onWhichFormChange: function onWhichFormChange(e) {
	      this.setState({ whichForm: e.target.value }, this.refreshList);
	    },
	    toggleParentActive: function toggleParentActive(e) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'span',
	              { title: 'Delete Selected', id: 'trash-subs', onClick: this.onTrash },
	              _react2.default.createElement('i', { className: 'icon-trash-1' })
	            ),
	            _react2.default.createElement(
	              'span',
	              { id: 'search-subs', onClick: this.toggleParentActive },
	              _react2.default.createElement(
	                'form',
	                { id: 'subs-search-form', onSubmit: this.updateSearch },
	                _react2.default.createElement('i', { className: 'icon-search' }),
	                _react2.default.createElement('input', { ref: 'searchInput', id: 'subs-search-input', type: 'text' })
	              )
	            ),
	            _react2.default.createElement(
	              'span',
	              { id: 'export-subs', title: 'Export Entries', onClick: this.toggleParentActive },
	              _react2.default.createElement(
	                'select',
	                { id: 'which-form-export' },
	                window.formsList.map(function (form) {
	                  return _react2.default.createElement(
	                    'option',
	                    { value: form.id, key: form.id },
	                    form.name
	                  );
	                })
	              ),
	              ...
	              _react2.default.createElement('i', { className: 'icon-export' })
	            ),
	            _react2.default.createElement(
	              'span',
	        ...
	        _react2.default.createElement(SubmissionList, _extends({}, this.state, { onWhichFormChange: this.onWhichFormChange, onTrash: this.onTrash, onSort: this.onSort })),
	        _react2.default.createElement(Pagination, { updatePage: this.updatePage, currentPage: this.state.currentPage, data: [this.state.pages] })
	      );
	    }
	  });
	  var SubmissionList = _react2.default.createClass({
	    ...
	    render: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'table_list subs_list list block' },
	        _react2.default.createElement(
	          'div',
	          { className: 'tr thead' },
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'label',
	              null,
	              _react2.default.createElement('input', { className: 'subs_checked_parent groupCheckedParent', name: 'subs_checked_parent', type: 'checkbox' })
	            )
	          ),
	          _react2.default.createElement(
	            'span',
	            ...
	            _react2.default.createElement(
	              'select',
	              { id: 'which-form', onChange: this.props.onWhichFormChange },
	              _react2.default.createElement(
	                'option',
	                { value: '0' },
	                'All Forms'
	          ...
	          _react2.default.createElement(
	            'span',
	            { style: { lineHeight: '23px', width: '36.3%', float: 'right' }, className: 'sortable', onClick: this.props.onSort.bind(null, 'created') },
	            'Received',
	            this.props.sortWhat === 'created' && this.props.sortOrder === 'ASC' ? _react2.default.createElement('i', { className: 'icon-angle-up' }) : '',
	            this.props.sortWhat === 'created' && this.props.sortOrder === 'DESC' ? _react2.default.createElement('i', { className: 'icon-angle-down' }) : ''
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          this.props.submissions.map(function (submission) {
	            return _react2.default.createElement(
	              'div',
	              { className: 'tr', key: submission.id },
	              _react2.default.createElement(
	                'label',
	                { style: { width: '10%' } },
	                _react2.default.createElement('input', { value: submission.id, className: 'subs_checked groupChecked', name: 'subs_checked', type: 'checkbox' })
	              ),
	              _react2.default.createElement(
	                'a',
	                { style: { width: '53%' }, onClick: SubmissionViewClass.showSubmission.bind(null, submission.id), className: 'load-submission', 'data-id': submission.id },
	                submission.form_name
	              ),
	              _react2.default.createElement(
	                'a',
	                { style: { width: '37%' }, onClick: SubmissionViewClass.showSubmission.bind(null, submission.id), className: 'load-submission', 'data-id': submission.id },
	                submission.created
	              )
	            );
	          })
	  ...
	  var SubmissionView = _react2.default.createClass({
	    displayName: 'SubmissionView',
	    ...
	    showSubmission: function showSubmission(id) {
	      this.setState({ loading: true, selectedSubmission: id });
	    ...
	    toggleShowEmpty: function toggleShowEmpty() {
	      this.setState({ showEmptyFields: !this.state.showEmptyFields });
	    },
	    render: function render() {
	      var renderSubmission = [];
	      var _iteratorNormalCompletion = true;
	      var _didIteratorError = false;
	      var _iteratorError = undefined;

	      try {
	        for (var _iterator = this.state.submissionContent[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          ...
	          if (submission.type === 'dropdown' || submission.type === 'checkbox') {
	            ...
	            for (var y in submission.value) {
	              for (var z in submission.options) {
	            ...
	            for (var _y in submission.value) {
	              submission.value[_y] = submission.value[_y].question + ': ' + submission.value[_y].value;
	            }
	          }
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'large-8 column subs_content' },
	        _react2.default.createElement(
	          'h2',
	          null,
	          'Submission Content'
	        ...
	        _react2.default.createElement(
	          'div',
	          { id: 'submission_body_cover', 'data-id': this.state.submssionID, className: 'block ' + (this.state.showEmptyFields ? '' : 'hide-empty') },
	          _react2.default.createElement(
	            'div',
	            ...
	            _react2.default.createElement(
	              'button',
	              { onClick: this.toggleShowEmpty, id: 'show-empty-sub' },
	              this.state.showEmptyFields ? 'Hide' : 'Show',
	              ' Empty Fields'
	            ),
	            _react2.default.createElement(
	              'button',
	            ...
	            _react2.default.createElement('i', { className: 'icon-spin5 animate-spin' })
	          ),
	          _react2.default.createElement(
	            'div',
	            { id: 'submission_meta' },
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'a',
	                { target: '_blank', href: this.state.visitorURL },
	                this.state.visitorURL
	              )
	            )
	          ),
	          _react2.default.createElement(
	            'div',
	            { id: 'submission_body', className: 'loading-' + this.state.loading },
	            Object.keys(renderSubmission).map(function (pageIndex) {
	              var thisPage = renderSubmission[pageIndex];
	              var isArray = void 0,
	                  isEditable = void 0,
	                  newClass = void 0;
	              var html = '<span class=\'title show-' + Object.keys(renderSubmission).length + '\'>' + pageIndex + '</span>';
	              for (var field in thisPage) {
	                if (typeof thisPage[field].url !== 'undefined') {
	                  var tempValue = [];
	                  for (var x in thisPage[field].value) {
	                    tempValue[x] = '<a href="' + thisPage[field].url[x] + '">' + thisPage[field].value[x] + '</a>';
	                  }
	                  thisPage[field].value = '';
	                  thisPage[field].value = tempValue.join('\n');
	                } else if (_typeof(thisPage[field].value) === 'object') {
	                  thisPage[field].value = thisPage[field].value.join('\n');
	                }

	                isArray = thisPage[field].type === 'checkbox' || thisPage[field].type === 'fileupload';
	                isEditable = thisPage[field].type !== 'fileupload' && thisPage[field].type !== 'signature';
	                ...
	                if (thisPage[field].type === 'heading') {
	                  html += '<div style=\'width: ' + thisPage[field].width + '\' ' + newClass + '><span data-array=\'' + isArray + '\' data-editable=\'' + isEditable + '\' data-identifier=\'' + thisPage[field].identifier + '\' class=\'is-heading value editable-' + isEditable + '\'>' + thisPage[field].value + '</span></div>';
	                } else if (thisPage[field].type === 'signature') {
	                  html += '<div style=\'width: ' + thisPage[field].width + '\' ' + newClass + '><span class=\'label\'>' + thisPage[field].label + '</span><span data-array=\'' + isArray + '\' data-editable=\'' + isEditable + '\' data-identifier=\'' + thisPage[field].identifier + '\' class=\'value editable-' + isEditable + '\'><img src=\'' + thisPage[field].value + '\'/></span></div>';
	                } else {
	                  html += '<div style=\'width: ' + thisPage[field].width + '\' ' + newClass + '><span class=\'label\'>' + thisPage[field].label + '</span><span data-array=\'' + isArray + '\' data-editable=\'' + isEditable + '\' data-identifier=\'' + thisPage[field].identifier + '\' class=\'value editable-' + isEditable + '\'>' + thisPage[field].value + '</span></div>';
	                }
	              }
	              html = '' + html;
	              return _react2.default.createElement('div', { key: pageIndex, dangerouslySetInnerHTML: { __html: html } });
	            }),
	            _react2.default.createElement(
	              'div',
	              { id: 'empty-submission-content', style: { display: typeof this.state.submssionID === 'undefined' ? 'block' : 'none' } },
	  ...
	  */
	  var FormCover = _react2.default.createClass({
	    displayName: 'FormCover',
	    ...
	    refreshList: function refreshList() {
	      ...
	      this.setState({ loading: true });
	      this.serverRequest = jQuery.getJSON(FC_1.ajaxurl + '?action=formcraft3_get_forms&page=' + this.state.currentPage + '&query=' + this.state.query + '&sortWhat=' + this.state.sortWhat + '&sortOrder=' + this.state.sortOrder, function (result) {
	        _this.setState({
	          pages: result.pages,
	          total: result.total,
	          forms: result.forms || [],
	    ...
	    onTrash: function onTrash(form) {
	      var _this2 = this;

	      this.setState({ loading: true });
	      this.serverRequest = jQuery.getJSON(FC_1.ajaxurl + '?action=formcraft3_del_form&form=' + form, function (result) {
	        if (result.success) {
	          _this2.refreshList();
	        }
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'span',
	              { id: 'search-form', onClick: this.toggleParentActive },
	              _react2.default.createElement(
	                'form',
	                { id: 'form-search-form', onSubmit: this.updateSearch },
	                _react2.default.createElement('i', { className: 'icon-search' }),
	                _react2.default.createElement('input', { id: 'form-search-input', type: 'text' })
	              )
	            ),
	            _react2.default.createElement(
	              'span',
	        ...
	        _react2.default.createElement(FormList, _extends({}, this.state, { onTrash: this.onTrash, onSort: this.onSort })),
	        _react2.default.createElement(Pagination, { updatePage: this.updatePage, currentPage: this.state.currentPage, data: [this.state.pages] }),
	        this.props.children
	      );
	    }
	  ...
	  var FormList = _react2.default.createClass({
	    ...
	    render: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'table_list form_list' },
	          _react2.default.createElement(
	            'div',
	            { className: 'tr thead' },
	            _react2.default.createElement(
	              'span',
	              { style: { width: '10%' }, className: 'sortable', onClick: this.props.onSort.bind(null, 'ID') },
	              'ID',
	              this.props.sortWhat === 'ID' && this.props.sortOrder === 'ASC' ? _react2.default.createElement('i', { className: 'icon-angle-up' }) : '',
	              this.props.sortWhat === 'ID' && this.props.sortOrder === 'DESC' ? _react2.default.createElement('i', { className: 'icon-angle-down' }) : ''
	            ),
	            _react2.default.createElement(
	              'span',
	              { style: { width: '45%' }, className: 'sortable', onClick: this.props.onSort.bind(null, 'name') },
	              'Name',
	              this.props.sortWhat === 'name' && this.props.sortOrder === 'ASC' ? _react2.default.createElement('i', { className: 'icon-angle-up' }) : '',
	              this.props.sortWhat === 'name' && this.props.sortOrder === 'DESC' ? _react2.default.createElement('i', { className: 'icon-angle-down' }) : ''
	            ),
	            _react2.default.createElement(
	              'span',
	              { style: { width: '35%' }, className: 'sortable', onClick: this.props.onSort.bind(null, 'modified') },
	              'Last Edit',
	              this.props.sortWhat === 'modified' && this.props.sortOrder === 'ASC' ? _react2.default.createElement('i', { className: 'icon-angle-down' }) : '',
	              this.props.sortWhat === 'modified' && this.props.sortOrder === 'DESC' ? _react2.default.createElement('i', { className: 'icon-angle-up' }) : ''
	            ),
	            _react2.default.createElement('span', { style: { width: '9%', float: 'right' } })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'tbody loading-' + this.props.loading },
	            this.props.forms.map(function (form) {
	              return _react2.default.createElement(
	                'div',
	                { key: form.id, className: 'tr form-' + form.id },
	                _react2.default.createElement(
	                  'a',
	                  { style: { width: '10%' }, href: 'admin.php?page=formcraft3_dashboard&id=' + form.id },
	                  form.id
	                ),
	                _react2.default.createElement(
	                  'a',
	                  { title: form.name, style: { width: '45%' }, href: 'admin.php?page=formcraft3_dashboard&id=' + form.id },
	                  form.name
	                ),
	                _react2.default.createElement(
	                  'a',
	                  { style: { width: '35%' }, href: 'admin.php?page=formcraft3_dashboard&id=' + form.id },
	                  form.modified
	                ),
	                _react2.default.createElement(
	                  'span',
	                  { style: { width: '10%' } },
	                  _this3.props.onTrash ? _react2.default.createElement('i', { 'data-id': form.id, onClick: _this3.props.onTrash.bind(null, form.id), className: 'trash-icon trash-form icon-trash-1' }) : ''
	                )
	              );
	            })
	          )
	  ...
	  */
	  var Pagination = _react2.default.createClass({
	    ...
	    moveLeft: function moveLeft(e) {
	      var element = jQuery(e.currentTarget).parent().parent().find('.pagination > div');
	      var left = parseInt(element.css('left'), 10) + 150;
	    ...
	    render: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'pagination-cover forms-pagination' },
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            ...
	            this.props.data.map(function () {
	              var pageList = [];
	              for (var x = 1; x <= _this4.props.data[0]; x++) {
	                pageList.push(_react2.default.createElement(
	                  'span',
	                  { key: x, className: x === _this4.props.currentPage ? 'active' : '', onClick: _this4.props.updatePage.bind(null, x) },
	                  x
	                ));
	              }
	              return pageList;
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'pagination-move' },
	          _react2.default.createElement('i', { className: 'icon-angle-left', onClick: this.moveLeft }),
	          _react2.default.createElement('i', { className: 'icon-angle-right', onClick: this.moveRight })
	        )
	      );
	    }
	  });
	  ...
	  * Create Form List Table Elements
	  */
	  var SurveyCover = _react2.default.createClass({
	    displayName: 'SurveyCover',
	    ...
	    setChartDates: function setChartDates() {
	      var options = {};
	      options.beforeShow = function () {
	        jQuery('#ui-datepicker-div').removeClass('ui-datepicker').addClass('fc-datepicker');
	      };
	      options.onClose = function () {
	        if (jQuery(this).attr('id') === 'survey-from') {
	          var minDate = jQuery('#survey-from').datepicker('getDate');
	          jQuery('#survey-to').datepicker('option', 'minDate', minDate);
	          jQuery('#survey-to').trigger('focus');
	        }
	        if (jQuery(this).attr('id') === 'survey-to') {
	          jQuery('[name="pre-selected"]').removeAttr('checked').trigger('change');
	          SurveyCoverClass.getAnalytics();
	        }
	      };
	      ...
	      jQuery('#survey-from, #survey-to').datepicker(options);
	      jQuery('#survey-from').datepicker('setDate', -7);
	      jQuery('#survey-to').datepicker('setDate', new Date());
	    },
	    componentDidMount: function componentDidMount() {
	      this.setChartDates();
	      this.refreshList();
	    ...
	    chartColors: [{ border: 'rgba(156,42,42,.8)', background: 'rgba(156,42,42,.5)' }, { border: 'rgba(95,158,160,.8)', background: 'rgba(95,158,160,.5)' }, { border: 'rgba(72,61,139,.8)', background: 'rgba(72,61,139,.5)' }, { border: 'rgba(238,232,170,.8)', background: 'rgba(238,232,170,.5)' }, { border: 'rgba(0,139,139,.8)', background: 'rgba(0,139,139,.5)' }],
	    getAnalytics: function getAnalytics(ID) {
	      var _this6 = this;

	      ID = ID || this.state.selectedForm;
	      if (ID === false) return false;
	      this.setState({ loading: true, selectedForm: ID, hasAnalytics: true });
	      var dateFrom = encodeURIComponent(jQuery.datepicker.formatDate('yy-M-dd', jQuery('#survey-from').datepicker('getDate')));
	      var dateTo = encodeURIComponent(jQuery.datepicker.formatDate('yy-M-dd', jQuery('#survey-to').datepicker('getDate')));
	      var maxEntries = this.state.maxEntries;
	      this.serverRequest = jQuery.getJSON(FC_1.ajaxurl + '?action=formcraft3_get_survey_analytics&id=' + ID + '&from=' + dateFrom + '&to=' + dateTo + '&maxEntries=' + maxEntries, function (result) {
	        if (result.success) {
	          jQuery('.survey-charts-cover').find('.survey-canvas-cover-all').html('');
	          var i = 0;
	          if (Object.keys(result.charts).length === 0) {
	            _this6.setState({ hasAnalytics: false });
	          }
	          for (var fieldID in result.charts) {
	            var toPlotMain = {};
	            toPlotMain.type = 'bar';
	            toPlotMain.data = {};
	            toPlotMain.data.labels = result.charts[fieldID].labelsAlt ? result.charts[fieldID].labelsAlt : result.charts[fieldID].labels;
	            toPlotMain.data.datasets = [];
	            toPlotMain.data.datasets.push({
	              label: result.charts[fieldID].label,
	              borderColor: _this6.chartColors[i].border,
	              backgroundColor: _this6.chartColors[i].background,
	              borderWidth: 1,
	              tickMarkLength: 20,
	              data: result.charts[fieldID].data
	            });
	            toPlotMain.options = {};
	            toPlotMain.options.legend = { display: false };
	            toPlotMain.options.scales = {
	              yAxes: [{
	                ticks: {
	                  beginAtZero: true,
	            ...
	            result.charts[fieldID].label = result.charts[fieldID].label === '' ? '(no label field)' : result.charts[fieldID].label;
	            var canvasCover = jQuery('<div class="survey-canvas-cover"><div class="block"><span style=\'font-weight: bold\'>' + result.charts[fieldID].label + '</span><span>total entries analyzed: ' + result.charts[fieldID].totalAnalyzed + '</span><canvas></canvas></div></div>').appendTo('.survey-canvas-cover-all');
	            if (result.charts[fieldID].labels.length > 5 || Object.keys(result.charts).length === 1) {
	              canvasCover.addClass('full-width');
	            }
	            var canvas = canvasCover.find('canvas')[0];
	            var temp = new Chart(canvas, toPlotMain);
	            i++;
	            i = i === _this6.chartColors.length ? 0 : i;
	          }
	    ...
	    render: function render() {
	      ...
	      return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'span',
	                  { style: { width: '13%' }, className: 'sortable', onClick: this.onSort.bind(null, 'ID') },
	                  'ID',
	                  this.state.sortWhat === 'ID' && this.state.sortOrder === 'ASC' ? _react2.default.createElement('i', { className: 'icon-angle-up' }) : '',
	                  this.state.sortWhat === 'ID' && this.state.sortOrder === 'DESC' ? _react2.default.createElement('i', { className: 'icon-angle-down' }) : ''
	                ),
	                _react2.default.createElement(
	                  'span',
	                  { style: { width: '87%' }, className: 'sortable', onClick: this.onSort.bind(null, 'name') },
	                  'Name',
	                  this.state.sortWhat === 'name' && this.state.sortOrder === 'ASC' ? _react2.default.createElement('i', { className: 'icon-angle-up' }) : '',
	                  this.state.sortWhat === 'name' && this.state.sortOrder === 'DESC' ? _react2.default.createElement('i', { className: 'icon-angle-down' }) : ''
	                )
	              ),
	              _react2.default.createElement(
	                'div',
	                { className: 'tbody loading-' + this.state.loading },
	                this.state.forms.map(function (form) {
	                  return _react2.default.createElement(
	                    'div',
	                    { style: { cursor: 'pointer' }, key: form.id, className: 'tr form-' + form.id + ' ' + (_this7.state.selectedForm === form.id ? 'active' : ''), onClick: _this7.getAnalytics.bind(_this7, form.id) },
	                    _react2.default.createElement(
	                      'span',
	                      { style: { width: '13%' } },
	                      form.id
	                    ...
	                    _react2.default.createElement(
	                      'span',
	                      { title: form.name, style: { width: '87%' } },
	                      form.name
	                    )
	                  );
	                })
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'large-9 column survey-charts-cover' },
	          _react2.default.createElement(
	            'div',
	            { className: 'block SurveyHeader' },
	            _react2.default.createElement(
	              'span',
	              null,
	              'Max Entries To Analyze: ',
	              _react2.default.createElement('input', { type: 'text', onChange: function onChange(e) {
	                  return _this7.setState({ maxEntries: e.target.value });
	                }, value: this.state.maxEntries })
	            ),
	            _react2.default.createElement(
	              'span',
	              { style: { borderLeft: '1px solid #dadade', paddingLeft: '15px' } },
	              'From:',
	              _react2.default.createElement('input', { type: 'text', id: 'survey-from', className: 'fc-date' }),
	              'To:',
	              _react2.default.createElement('input', { type: 'text', id: 'survey-to', className: 'fc-date' })
	            )
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'block no-survey', style: { display: this.state.selectedForm === false ? 'block' : 'none' } },
	            'click on a form to view analytics'
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'block no-survey', style: { display: this.state.hasAnalytics === false ? 'block' : 'none' } },
	            'this form has no analytics'
	          ),
	          _react2.default.createElement('div', { className: 'survey-canvas-cover-all' })
	        )
	      );
	    }
	  });
	  ...
	  */
	  var AnalyticsCover = _react2.default.createClass({
	    displayName: 'AnalyticsCover',

	    setChartDates: function setChartDates() {
	      var preset = arguments.length <= 0 || arguments[0] === undefined ? 'w' : arguments[0];
	      ...
	      if (preset === 'w') {
	        ...
	        var dateTo = new Date(new Date().getUTCFullYear(), new Date().getUTCMonth() + 1, 0);
	        var dateFrom = new Date(new Date().getUTCFullYear(), new Date().getUTCMonth(), 1);
	        jQuery('#chart-from').datepicker('setDate', dateFrom);
	        jQuery('#chart-to').datepicker('setDate', dateTo);
	      } else if (preset === 'y') {
	        var _dateFrom = new Date(new Date().getUTCFullYear(), 0, 1);
	        var _dateTo = new Date(new Date().getUTCFullYear(), 11, 31);
	        jQuery('#chart-from').datepicker('setDate', _dateFrom);
	        jQuery('#chart-to').datepicker('setDate', _dateTo);
	      }
	      this.refreshChart();
	    },
	    plotChart: function plotChart(labels, views, submissions, payments) {
	      ...
	      var viewsSum = views.reduce(function (x, y) {
	        return x + y;
	      });
	      var submissionsSum = submissions.reduce(function (x, y) {
	        return x + y;
	      });
	      var paymentsSum = payments.reduce(function (x, y) {
	        return x + y;
	      });

	      var conversion = viewsSum === 0 ? 0 : Math.round(parseFloat(submissionsSum / viewsSum) * 1000) / 10;
	      var conversionPayments = viewsSum === 0 ? 0 : Math.round(parseFloat(paymentsSum / viewsSum) * 1000) / 10;

	      _helpers2.default.spinTo('#views', viewsSum);
	      _helpers2.default.spinTo('#submissions', submissionsSum);
	      _helpers2.default.spinTo('#conversion', conversion);
	      _helpers2.default.spinTo('#conversionPayments', conversionPayments);
	      _helpers2.default.spinTo('#payments', paymentsSum);

	      var toPlotMain = {};
	      toPlotMain.type = 'line';
	      toPlotMain.data = {};
	      toPlotMain.data.labels = labels;
	      toPlotMain.data.datasets = [];
	      if (paymentsSum > 0) {
	      ...
	      if (typeof window.myLineChartIs !== 'undefined') {
	        ...
	        window.myLineChart.data.datasets = toPlotMain.data.datasets;
	        window.myLineChart.update();
	      } else {
	        window.myLineChart = new Chart(document.getElementById('chart').getContext('2d'), toPlotMain);
	    ...
	    refreshChart: function refreshChart() {
	      var dateFrom = encodeURIComponent(jQuery.datepicker.formatDate('yy-M-dd', jQuery('#chart-from').datepicker('getDate')));
	    ...
	    render: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { id: 'reset-analytics', onClick: this.resetAnalytics },
	          '(reset analytics data)'
	        ),
	        _react2.default.createElement(
	          'div',
	          { id: 'form_options', className: 'block' },
	          _react2.default.createElement(
	            'div',
	            { id: 'chart-options' },
	            _react2.default.createElement(
	              'span',
	              { className: 'hide-checkbox update-checkbox' },
	              _react2.default.createElement(
	                'span',
	                { className: 'active' },
	                'this'
	              ...
	              _react2.default.createElement(
	                'label',
	                null,
	                _react2.default.createElement('input', { onClick: this.setChartDates.bind(null, 'w'), value: 'week', name: 'pre-selected', type: 'radio' }),
	                'Week'
	              ),
	              _react2.default.createElement(
	                'label',
	                null,
	                _react2.default.createElement('input', { onClick: this.setChartDates.bind(null, 'm'), value: 'month', name: 'pre-selected', type: 'radio' }),
	                'Month'
	              ),
	              _react2.default.createElement(
	                'label',
	                null,
	                _react2.default.createElement('input', { onClick: this.setChartDates.bind(null, 'y'), value: 'year', name: 'pre-selected', type: 'radio' }),
	                'Year'
	              )
	            ),
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                'from',
	                _react2.default.createElement('input', { type: 'text', id: 'chart-from', className: 'fc-date' }),
	                'to',
	                _react2.default.createElement('input', { type: 'text', id: 'chart-to', className: 'fc-date' }),
	                'for',
	                _react2.default.createElement(
	                  'select',
	                  { id: 'chart-form', onChange: this.refreshChart },
	                  _react2.default.createElement(
	                    'option',
	                    { value: '0' },
	                    'All Forms'
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'row fc-header' },
	            _react2.default.createElement(
	              'div',
	              { className: 'small-4 column' },
	              _react2.default.createElement(
	                'span',
	                { className: 'one', style: { borderColor: 'inherit' } },
	                _react2.default.createElement(
	                  'span',
	                  { id: 'views' },
	                  '0'
	              ...
	              _react2.default.createElement(
	                'span',
	                { style: { color: 'rgba(237, 133, 66,.92)' }, className: 'two' },
	                'form views'
	              )
	            ),
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'span',
	                { style: { color: 'rgba(59,161,218, .9)' }, className: 'two' },
	                'submissions'
	              )
	            ),
	            _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'small-4 column pay-class', style: { display: 'none' } },
	              _react2.default.createElement(
	                'span',
	                { className: 'one' },
	                _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'span',
	                { style: { color: 'rgb(93, 168, 93)' }, className: 'two' },
	                'charges'
	              )
	            ),
	            _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('canvas', { id: 'chart', height: '317', style: { width: '100%', height: '317px' } })
	          )
	        )
	      );
	    }
	  ...
	  var FormCoverClass = _reactDom2.default.render(_react2.default.createElement(FormCover, null), document.getElementById('form-cover'));
	  var SubmissionCoverClass = _reactDom2.default.render(_react2.default.createElement(SubmissionCover, null), document.getElementById('submission-cover'));
	  var FilesCoverClass = _reactDom2.default.render(_react2.default.createElement(FilesCover, null), document.getElementById('files-cover'));
	  var SurveyCoverClass = _reactDom2.default.render(_react2.default.createElement(SurveyCover, null), document.getElementById('survey-cover'));
	  var SubmissionViewClass = _reactDom2.default.render(_react2.default.createElement(SubmissionView, null), document.getElementById('submission-view'));
	  var AnalyticsCoverClass = _reactDom2.default.render(_react2.default.createElement(AnalyticsCover, null), document.getElementById('analytics-cover'));
	});
	...
	jQuery(document).ready(function () {
	  ...
	  jQuery('body').on('click', '.groupChecked', function (e) {
	    var checkbox = jQuery('.groupChecked');
	    if (!lastChecked) {
	      lastChecked = this;
	      return;
	    }
	  ...
	  jQuery('body').on('change', '.groupChecked', function () {
	    var len = jQuery('.groupChecked:checked').length;
	    if (len === 0) {
	  ...
	  jQuery('body').on('click', '#edit-sub', function () {
	    ...
	    jQuery('#submission_body .value').each(function () {
	      if (jQuery(this).attr('data-editable') === 'true') {
	        ...
	        var isArray = jQuery(this).attr('data-array');
