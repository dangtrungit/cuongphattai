...
<?php 
	$not_home = false;
	require_once ("css/customize.php");
	if ( is_single() ) {
		require_once ("css/single.php");
		$not_home = true;
	}elseif( is_category() ){
		require_once ("css/archive.php");
		$not_home = true;
	}

	if( is_product() ){
		require_once ("css/single-product.php");
		$not_home = true;
	}

	if ( is_product_category() || is_shop() ) {
		require_once ("css/product-category.php");
		$not_home = true;
	}

	if( $not_home == false ){
		require_once ("css/home.php");
    }
 ?>